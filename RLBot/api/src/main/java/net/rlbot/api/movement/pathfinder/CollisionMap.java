...
public interface CollisionMap
{
	...
	{
		return n(position.getX(), position.getY(), position.getPlane());
	}

	default boolean s(Position position)
	{
		return s(position.getX(), position.getY(), position.getPlane());
	}

	default boolean w(Position position)
	{
		return w(position.getX(), position.getY(), position.getPlane());
	}

	default boolean e(Position position)
	{
		return e(position.getX(), position.getY(), position.getPlane());
	}

	default boolean ne(Position position)
	{
		return ne(position.getX(), position.getY(), position.getPlane());
	}

	default boolean nw(Position position)
	{
		return nw(position.getX(), position.getY(), position.getPlane());
	}

	default boolean se(Position position)
	{
		return se(position.getX(), position.getY(), position.getPlane());
	}

	default boolean sw(Position position)
	{
		return sw(position.getX(), position.getY(), position.getPlane());
	}
