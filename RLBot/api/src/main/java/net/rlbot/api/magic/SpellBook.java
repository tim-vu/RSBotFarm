...
public enum SpellBook
{
    ...
    SpellBook(int varbitValue, Spell[] spells)
    {
    ...
    public enum Standard implements Spell
    {
        ...
        @Getter
        private final Set<RuneRequirement> runeRequirements;

        Standard(int level, WidgetInfo widgetInfo, int autocastIndex, boolean members, RuneRequirement... requirements) {
            this.level = level;
            this.widgetInfo = widgetInfo;
            this.autocastIndex = autocastIndex;
            this.members = members;
            this.runeRequirements = Set.of(requirements);
        }

        Standard(int level, WidgetInfo widgetInfo, boolean members, RuneRequirement... requirements)
        {
            this(level, widgetInfo, -1, members, requirements);
        }
        ...
        {
            for (RuneRequirement req : runeRequirements)
            {
        ...
        public boolean haveEquipment()
        {
            return switch (this) {
                case IBAN_BLAST ->
                        Equipment.contains(ItemID.IBANS_STAFF, ItemID.IBANS_STAFF_1410, ItemID.IBANS_STAFF_U);
                case MAGIC_DART ->
                        Equipment.contains(ItemID.SLAYERS_STAFF_E, ItemID.SLAYERS_STAFF, ItemID.STAFF_OF_THE_DEAD, ItemID.STAFF_OF_THE_DEAD_23613, ItemID.TOXIC_STAFF_OF_THE_DEAD, ItemID.STAFF_OF_LIGHT, ItemID.STAFF_OF_BALANCE);
                case SARADOMIN_STRIKE -> Equipment.contains(ItemID.SARADOMIN_STAFF, ItemID.STAFF_OF_LIGHT);
                case FLAMES_OF_ZAMORAK ->
                        Equipment.contains(ItemID.ZAMORAK_STAFF, ItemID.STAFF_OF_THE_DEAD, ItemID.STAFF_OF_THE_DEAD_23613, ItemID.TOXIC_STAFF_OF_THE_DEAD);
                case CLAWS_OF_GUTHIX ->
                        Equipment.contains(ItemID.GUTHIX_STAFF, ItemID.VOID_KNIGHT_MACE, ItemID.STAFF_OF_BALANCE);
                default -> true;
            };
        }
        ...
        {
            return switch (this) {
                case TELEPORT_TO_APE_ATOLL -> Inventory.contains(ItemID.BANANA);
                case CHARGE_AIR_ORB, CHARGE_WATER_ORB, CHARGE_EARTH_ORB, CHARGE_FIRE_ORB ->
                        Inventory.contains(ItemID.UNPOWERED_ORB);
                default -> true;
            };
        }
    }
